...
<!-- 	            	<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" id="userName" class="form-control mt10" name="userName" value = "${nickname}"/><span id="nameChk"></span>
						</div>
					</div>
	            	<div class="form-group">
	            	...
	            	<div class="form-group">
	            		...
	            		<div class="col-sm-10">
	            			<input type="date" id="userBirthday" class="form-control mt10" name="userBirthday" value="${birth}" />
	            		</div>
	            	</div>
	            	<div class="form-group">
